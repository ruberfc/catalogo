...
<aside class="app-sidebar">
        <div class="app-sidebar__user">
                <div class="m-2">
                        <img class="img-fluid" src="images/usuario.png" alt="User Image">
                </div>
        ...
        <ul class="app-menu">
                ...
                <li><a class="app-menu__item" href="categoria.php"><i class="app-menu__icon fa fa-align-left"></i><span class="app-menu__label">Categorias</span></a></li>
                ...
                <li><a class="app-menu__item" href="empleados.php"><i class="app-menu__icon fa fa-address-book-o"></i><span class="app-menu__label">Usuarios</span></a></li>
